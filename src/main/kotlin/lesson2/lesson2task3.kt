...
fun main() {
    ...
    val hoursOfTravel = travelMinutes / MINUTES_IN_HOUR // 7
    val minutesOfTravelLeft = travelMinutes % MINUTES_IN_HOUR // 37

    val sumOfMinutes = minuteOfDeparture + minutesOfTravelLeft
    val minutesLeft = sumOfMinutes % MINUTES_IN_HOUR
    val hoursFromMinutes = sumOfMinutes / MINUTES_IN_HOUR
